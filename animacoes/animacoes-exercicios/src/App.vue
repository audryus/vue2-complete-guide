<template>
	<div id="app" class="container-fluid">
		...
		<hr>
		<b-button @click="adicionarAluno" class="mb-4">Adicionr Aluno</b-button>
	...
	methods: {
		...
		animar(el, done, negativo) {
			...
			const tempo = setInterval(() => {
				const novaLargura = this.larguraBase + (negativo ? -1 : 1) * (rodada * 10)
